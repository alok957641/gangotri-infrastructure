...
const categories = [
  {
    ...
    lede: 'Homes across Shahjahanpur, Lucknow and nearby UP cities, on-grid since as early as 2014.',
  ...
  },
  {
    ...
    projects: [
      ...
      {
        name: 'Shahjahanpur Auto Components Plant',
        location: 'Shahjahanpur, UP',
        capacity: '750 kW',
        year: '2025',
